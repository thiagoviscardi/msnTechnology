...
const especialidade = "Analista de TI";
const valor = "200";
...
describe('Escalas Multiprofissional', () => {
    before(() => {
        cy.login();
    ...
    it('Incluir', () => {
        ...
        cy.get('[name="professional_type"]').last().click();
        cy.get('#group_id').type(`${especialidade}{enter}`, {delay:300});
    ...
    it('Editar e Adicionar Plantão', () => {
        ...
        cy.waiting('[title="Editar"]');
        cy.get('[title="Editar"]').eq(0).click();
        cy.get('#Especialidade').type(`Analista contábil{enter}`, {delay:800})
