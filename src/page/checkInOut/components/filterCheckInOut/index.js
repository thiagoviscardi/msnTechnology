...
import PaginationControlled from 'page/specificScale/components/pagination';
...
export default function FilterShiftsModal({
  ...
  const { dataScalesFilter, loadingScales, totalScales: total } = scalesFilter;
  ...
  const { scaleSearch } = scaleFilter;
  const [filterScale, setFilterScale] = React.useState({
    page: 1,
    perPage: 10,
  });
  ...
  const handlePageChange = (page) => {
    setFilterScale((oldstate) => ({ ...oldstate, page }));
  };
  ...
  }, [scaleFilter, unitId, filterScale.page]);
                          ...
                          <div>
                            ...
                            <div className={classes.root}>
                              <PaginationControlled
                                ...
                                total={total}
                                pageProps={filterScale.page}
                                perPage={filterScale.perPage}
                              />
                            </div>
                          </div>
                        )}
